package com.javers.books.backend.controllers;
...
import com.javers.books.backend.services.ILibroService;
...
public class LibroRestController {
	...
	public ResponseEntity<LibroResponseRest> consiultaPorId(@PathVariable Long id){
